...
KMeans.prototype.train = function(points, k, distance, snapshotPeriod, snapshotCb) {
   ...
   this.centroids = this.initCentroids(points, k, distance); // this.randomCentroids(points, k);
